...
export default function AboutHero() {
  return (
    <section className="relative w-full px-4 md:px-8 lg:px-16 pt-2 pb-20 md:pt-20 md:pb-32 overflow-hidden flex flex-col items-center justify-center min-h-[50vh] bg-white">
      ...
      <div className="absolute bottom-0 -right-40 w-[600px] h-[600px] bg-orange-50/40 rounded-full blur-[120px] pointer-events-none mix-blend-multiply" />
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-pink-300 to-orange-200 tracking-wide">
        ...
        >
          AI LifeBOT is a global leader in AI-powered customer service solutions, delivering cutting-edge chatbot and AI agent automation to revolutionize customer interactions. Our platform enables businesses to provide instant, personalized, and intelligent support across multiple channels, 24/7.
        </motion.p>
        ...
        >
          ...
          <p className="text-xl md:text-2xl font-medium text-gray-800 italic mb-6 leading-relaxed">
            "Our mission is to empower businesses with advanced AI solutions that enhance customer experience, streamline operations, and drive business growth."
          </p>

          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-gradient-to-r from-pink-400 via-pink-300 to-orange-200 flex items-center justify-center text-white font-bold text-sm">
              PA
            </div>
            <div className="text-left">
              <div className="font-bold text-gray-900">Puneet Agrawal</div>
