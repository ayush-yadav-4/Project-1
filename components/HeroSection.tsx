  ...
  return (
    ...
    >
      ...
      <div className="animate-fade-in-up mb-10">
        <div className="inline-flex items-center gap-2 rounded-full bg-white border border-gray-100 px-4 py-2 text-base sm:px-8 sm:py-3 sm:text-lg font-medium text-gray-800 shadow-sm animate-float">
      ...
      <div className="relative z-10 animate-fade-in-up delay-100">
        ...
        <h1 
          className="max-w-5xl text-3xl sm:text-4xl md:text-7xl font-normal tracking-tight mb-6 leading-tight font-[family-name:var(--font-inter)] text-black"
          style={{ textShadow: '0 0 10px rgba(250, 204, 21, 0.6), 0 0 20px rgba(234, 179, 8, 0.4)' }}
        >
        Bring 
        <span className="inline-flex items-center justify-center mx-2 sm:mx-3 align-middle hover:rotate-12 transition-transform duration-300">
          <div className="h-8 w-8 sm:h-10 sm:w-10 md:h-16 md:w-16 bg-orange-500 rounded-xl rotate-12 flex items-center justify-center shadow-lg shadow-orange-200 hover:rotate-0 transition-transform duration-300">
      ...
      {/* Subtext */}
      <p className="max-w-2xl text-sm sm:text-base text-gray-600 mb-10 animate-fade-in-up delay-200">
      ...
      <div className="mb-20 animate-fade-in-up delay-300">
        <Link 
          href="/marketplace" 
          className="rounded-full bg-white border border-gray-200 px-3 py-1.5 text-xs sm:px-8 sm:py-3 sm:text-base font-medium text-black hover:bg-gray-50 transition-all shadow-sm flex items-center gap-2 mx-auto hover:scale-105 active:scale-95 duration-300 min-w-[90px] max-w-[140px] sm:min-w-[120px] sm:max-w-[200px]"
        >
