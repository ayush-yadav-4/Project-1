...
export default function AIContractReview() {
  ...
  return (
    <section className="relative w-full pt-10 pb-96 bg-white overflow-hidden flex flex-col items-center">
      
      {/* 1. Icons Row - Extended with more icons */}
      <div className="w-full overflow-hidden mb-50 px-4 md:px-8">
        <div className="flex justify-between items-center gap-2 md:gap-4 w-full">
            ...
            {/* Linear */}
            <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-[#5E6AD2] flex items-center justify-center border border-gray-200 shadow-sm shrink-0 p-3">
                <svg viewBox="0 0 24 24" fill="white" className="w-full h-full">
            ...
            {/* Vercel */}
            <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-black flex items-center justify-center border border-gray-200 shadow-sm shrink-0 p-3">
                <svg viewBox="0 0 24 24" fill="white" className="w-full h-full">
      ...
      {/* 2. Enhanced Background Decorative Elements (Inspired by image) */}
      <div className="absolute top-[15%] right-[10%] opacity-20 pointer-events-none">
      ...
      <div className="absolute top-[40%] left-[8%] opacity-20 pointer-events-none rotate-45">
        <div className="flex gap-2">
          <div className="w-4 h-0.5 bg-gray-300 rounded-full" />
          <div className="w-0.5 h-4 bg-gray-300 rounded-full -ml-2.5" />
        </div>
      </div>
      <div className="absolute bottom-[20%] right-[15%] opacity-15 pointer-events-none">
         <Sparkles className="w-12 h-12 text-blue-400" />
      </div>
      
      <div className="absolute top-1/4 right-1/4 w-2 h-2 bg-blue-400 rounded-full opacity-40"></div>
      <div className="absolute bottom-1/4 left-1/3 w-3 h-3 bg-orange-300 rounded-full opacity-40"></div>
      <div className="absolute top-[10%] left-[5%] w-1.5 h-1.5 bg-pink-300 rounded-full opacity-30"></div>
      <div className="absolute bottom-[10%] right-[10%] w-2.5 h-2.5 bg-blue-300 rounded-full opacity-30"></div>
      
      {/* 3. Main Container - Reduced Size (Inspired by image) */}
      <div className="max-w-6xl w-full px-4 relative">
        <div className="relative mx-auto w-full max-w-5xl aspect-[16/10] bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden flex flex-col">
          ...
          <div className="flex flex-1 overflow-hidden">
            ...
            <div className="w-16 border-r border-gray-100 flex flex-col items-center py-6 gap-8 shrink-0 bg-white shadow-sm">
            ...
            <div className="flex-1 overflow-y-auto p-14 bg-gray-50/20 relative">
              ...
              <div className={`max-w-3xl mx-auto space-y-10 transition-all duration-700 ${isLoading ? 'opacity-40 blur-[2px]' : 'opacity-100 blur-0'}`}>
                ...
                <div className="space-y-8">
                  <div>
                    <h1 className="text-4xl font-black text-gray-900 tracking-tighter mb-2">Agent Marketplace Protocol</h1>
                    <p className="text-sm text-gray-500 font-medium italic">Standardized Interface for Autonomous Workforces</p>
                  </div>
                  
                  <div className="space-y-10">
                    <div>
                      <h3 className="text-sm font-black text-gray-900 mb-6 uppercase tracking-widest border-b border-gray-100 pb-2 flex items-center gap-2">
                    ...
                    <div className="space-y-4">
                      <h3 className="text-sm font-black text-gray-900 mb-4 uppercase tracking-widest border-b border-gray-100 pb-2">3. Integration Ecosystem</h3>
            ...
            <div className="w-64 border-l border-gray-100 bg-white p-8 shrink-0 flex flex-col gap-10 shadow-inner">
              <div>
          ...
          <div className="absolute right-[256px] top-[40%] bg-white shadow-2xl border border-gray-100 rounded-2xl flex flex-col p-2 gap-3 z-10 shrink-0">
        ...
        <motion.div 
          ...
          className="absolute -top-24 -left-28 z-20"
        >
        ...
        <motion.div 
          ...
          className="absolute top-[55%] -right-16 z-30"
        >
        ...
        <motion.div 
          ...
          className="absolute bottom-[40%] -left-16 z-30"
        >
